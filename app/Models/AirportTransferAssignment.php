...
class AirportTransferAssignment extends Model
{
    use HasFactory;
    ...
    public function scopeForBooking(Builder $query, AirportTransferBooking|int $booking): Builder
    {
        $bookingId = $booking instanceof AirportTransferBooking ? $booking->getKey() : $booking;

        return $query->where('airport_transfer_booking_id', $bookingId);
    }
