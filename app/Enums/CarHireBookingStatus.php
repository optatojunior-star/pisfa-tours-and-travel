...
enum CarHireBookingStatus: string
{
    ...
    /** @return list<string> */
    public static function vehicleHoldingValues(): array
    {
        return array_map(
            static fn (self $status): string => $status->value,
            array_filter(self::cases(), static fn (self $status): bool => $status->holdsVehicle()),
        );
    }
