...
abstract class CarHireMailNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
        return $channel === 'mail'
            ? [new RateLimited('car-hire-notification-mail')]
            : [];
    }
    ...
    {
        return rtrim((string) config('app.url'), '/').'/portal/car-hire/'.rawurlencode($reference);
    }
